...
const donorsImage = "https://igjnhwvtasegwyiwcdkr.supabase.co/storage/v1/object/public/assets/images/universecard.png";
      ...
      <div className="max-w-6xl w-full space-y-10 px-4 md:px-6">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="max-w-xl">
            ...
            <h1 className="text-4xl font-bold text-gray-800 dark:text-white mb-6">Get started with Donors today</h1>
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">The Donors feature offers a real-time overview of donor activity across the entire platform, ensuring you stay informed about your shared supporters. </p>
